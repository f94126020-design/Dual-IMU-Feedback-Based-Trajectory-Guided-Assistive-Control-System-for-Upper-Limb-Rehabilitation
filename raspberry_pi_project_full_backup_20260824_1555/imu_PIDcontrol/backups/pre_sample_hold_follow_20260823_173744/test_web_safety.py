...
class WebSafetyTests(unittest.TestCase):
    ...
    def test_home_and_status_are_available(self):
        ...
        self.assertIn("意圖觸發速度跟隨（無目標、無軌跡）", html)
        ...
        self.assertIn("速度跟隨最大 PWM", html)
        self.assertIn("意圖觸發速度跟隨", html)
        ...
        self.assertEqual(status["motor_output"]["event_following"]["pulse_duration_seconds"], 1.20)
        self.assertEqual(status["motor_output"]["event_following"]["blanking_duration_seconds"], 0.10)
