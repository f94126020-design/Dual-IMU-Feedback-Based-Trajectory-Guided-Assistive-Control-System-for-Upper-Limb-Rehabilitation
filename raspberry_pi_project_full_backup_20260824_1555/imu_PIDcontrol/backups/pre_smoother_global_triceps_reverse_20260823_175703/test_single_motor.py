...
class ProfileBControlTests(unittest.TestCase):
    ...
    def test_sample_hold_following_samples_only_while_output_is_zero(self):
        ...
        self.assertEqual(step(0.4, 100.0, -0.4, -100.0, 0.08), (0.0, 0.0))

        # Only displacement across the 80 ms motor-off window chooses the
        # held directions; instantaneous velocity arguments do not choose it.
        self.assertEqual(step(0.8, -100.0, -0.8, 100.0, 0.12), (50.0, -50.0))
        ...
        self.assertEqual(step(9.0, 50.0, -9.0, -50.0, 0.319), (50.0, -50.0))
        self.assertEqual(step(10.0, 50.0, -10.0, -50.0, 0.321), (0.0, 0.0))
        self.assertEqual(system.event_following_status("elbow")["state"], "blanking")
        ...
        self.assertEqual(step(10.0, 0.0, -10.0, 0.0, 0.361), (0.0, 0.0))
        self.assertEqual(step(10.8, 0.0, -10.8, 0.0, 0.441), (50.0, -50.0))
        self.assertEqual(step(12.0, 0.0, -12.0, 0.0, 0.65), (0.0, 0.0))
        self.assertEqual(step(12.0, 0.0, -12.0, 0.0, 0.69), (0.0, 0.0))
        self.assertEqual(step(12.8, 0.0, -12.8, 0.0, 0.77), (0.0, 0.0))
