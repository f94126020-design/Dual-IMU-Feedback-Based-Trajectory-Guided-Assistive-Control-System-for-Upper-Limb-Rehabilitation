...
class ProfileBControlTests(unittest.TestCase):
    ...
    def test_sample_hold_following_samples_only_while_output_is_zero(self):
        ...
        self.assertEqual(step(0.3, 100.0, -0.3, -100.0, 0.07), (0.0, 0.0))

        # Only displacement across the 60 ms motor-off window chooses the
        # held directions; instantaneous velocity arguments do not choose it.
        self.assertEqual(step(0.6, -100.0, -0.6, 100.0, 0.10), (50.0, -50.0))
        self.assertEqual(system.event_following_status("elbow")["state"], "drive")
        # Moderate live motion cannot change the held PWM during 160 ms.
        self.assertEqual(step(5.0, 50.0, -5.0, -50.0, 0.18), (50.0, -50.0))
        self.assertEqual(step(9.0, 50.0, -9.0, -50.0, 0.259), (50.0, -50.0))
        self.assertEqual(step(10.0, 50.0, -10.0, -50.0, 0.261), (0.0, 0.0))
        self.assertEqual(system.event_following_status("elbow")["state"], "blanking")
        ...
        self.assertEqual(step(10.0, 0.0, -10.0, 0.0, 0.301), (0.0, 0.0))
        self.assertEqual(step(10.6, 0.0, -10.6, 0.0, 0.361), (50.0, -50.0))
        self.assertEqual(step(12.0, 0.0, -12.0, 0.0, 0.521), (0.0, 0.0))
        self.assertEqual(step(12.0, 0.0, -12.0, 0.0, 0.561), (0.0, 0.0))
        self.assertEqual(step(12.6, 0.0, -12.6, 0.0, 0.621), (0.0, 0.0))
