...
class WebSafetyTests(unittest.TestCase):
    ...
    def test_home_and_status_are_available(self):
        ...
        self.assertEqual(status["motor_output"]["event_following"]["sample_duration_seconds"], 0.06)
        self.assertEqual(status["motor_output"]["event_following"]["hold_duration_seconds"], 0.16)
    ...
    def test_global_triceps_direction_is_reversed_only_at_final_gateway(self):
