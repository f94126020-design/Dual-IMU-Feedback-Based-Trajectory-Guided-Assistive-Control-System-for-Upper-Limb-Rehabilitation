...
class WebSafetyTests(unittest.TestCase):
    ...
    def test_home_and_status_are_available(self):
        ...
        self.assertIn("意圖觸發脈衝跟隨（無目標、無補償）", html)
        ...
        self.assertEqual(status["motor_output"]["event_following"]["pulse_duration_seconds"], 0.15)
        self.assertEqual(status["motor_output"]["event_following"]["blanking_duration_seconds"], 0.20)
