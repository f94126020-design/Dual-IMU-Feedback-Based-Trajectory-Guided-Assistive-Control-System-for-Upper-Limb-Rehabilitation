...
class WebSafetyTests(unittest.TestCase):
    ...
    def test_home_and_status_are_available(self):
        ...
        self.assertIn("/api/motor_jog/locks", html)
        ...
        self.assertEqual(status["motor_output"]["feedforward_min_pwm"], 200.0)
    ...
    def test_motor_jog_lock_blocks_only_selected_motor(self):
        response = self.client.post("/api/motor_jog/locks", json={
