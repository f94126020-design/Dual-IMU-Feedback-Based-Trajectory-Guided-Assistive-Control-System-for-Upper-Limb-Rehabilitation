...
<div class="container">
  <div>
    ...
    <div class="card">
      <h2>5. 馬達安全控制</h2>
      <div class="validation warning" id="dryRunBanner">LIVE 模式：確認啟動後會將 PWM 傳送至 ESP32。請先確認馬達固定、繩索未連接人體且急停可用。</div>
      <div class="grid2">
...
function updatePage(data){
  ...
  if(data.motor_output){
    ...
    setText('dryRunBanner','方案 B LIVE：肘肌反向 1:'+s.antagonist_release_gain
