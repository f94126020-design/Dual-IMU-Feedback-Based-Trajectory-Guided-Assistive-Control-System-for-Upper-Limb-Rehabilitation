...
class IMURehabSystem:
    ...
    def get_trajectory_time(self, now):
        if not self.is_trajectory_demo() or self.trajectory_started_at is None:
            return 0.0
    ...
    def read_frame(self):
        ...
        trajectory_time = self.get_trajectory_time(current_time) if self.is_trajectory_demo() else t
        ...
        return {
            ...
            ) if self.is_trajectory_demo() and self.trajectory_started_at is not None else 0.0,
