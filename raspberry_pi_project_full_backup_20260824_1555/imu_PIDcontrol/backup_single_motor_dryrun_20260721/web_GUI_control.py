...
<header>
  ...
  <p>先完成 IMU 安裝與方向驗證，再進行正弦軌跡跟隨或階躍測試</p>
</header>
<div class="container">
  <div>
    <div class="card">
    ...
    <div class="card">
      ...
      <p class="small" id="motorInterlockText">每次初始化後必須完成並套用 IMU 驗證，才可啟用馬達。</p>
    </div>
...
def serialize_frame(frame):
    ...
    for k in keys_float:
        try:
            ...
            out[k] = 0.0
    for k in ["motion_state","shoulder_motion_state","shoulder_plane","elbow_axis","target_mode","target_joint","controller_mode"]:
