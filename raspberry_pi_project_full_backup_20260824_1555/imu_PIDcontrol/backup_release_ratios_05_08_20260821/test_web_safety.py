...
class WebSafetyTests(unittest.TestCase):
    ...
    def test_home_and_status_are_available(self):
        ...
        self.assertIn('id="motorTestChannel"', html)
        self.assertIn('id="motorTestDirection"', html)
        self.assertIn("testSingleMotor", html)
        ...
        self.assertIn("setTimeout(pollStatus,document.hidden?1000:250)", html)
        ...
        self.assertEqual(status["motor_output"]["motor_min_pwm"], {"biceps": 200, "triceps": 200, "deltoid": 200})
